...
def get_langs(req: Request) -> dict[str, Any]:
    try:
...
def get_fluency(req: Request) -> dict[str, Any]:
    try:
...
def set_fluency_lang(req: Request, inp: SetFluency) -> dict[str, Any]:
    try:
...
def set_fluency_lang(req: Request, inp: SetDefaultLanguage) -> dict[str, Any]:
    try:
