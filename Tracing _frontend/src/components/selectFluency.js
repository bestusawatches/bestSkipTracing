  ...
  return (
    <ModalWrapper>
      ...
      <ModalSelector>
        {languageSelection === 1 && (
          <Language>
            <img src="/Brand/language.png" alt="imag"></img>
            <LanguageSelected>
        ...
        {languageSelection === 2 && (
          <>
            <Language>
              <img src="/Brand/spanish.svg" alt="imag"></img>
              <LanguageSelected>
                <div>Language Selected</div>
                <span>Spanish</span>
              </LanguageSelected>
      ...
      <ModalSlider>
        <Box sx={{ width: getWidth() }}>
          <div style={{ opacity: 1 }}>
            <CustomizedSlider
              orientation={windowSize.width < 400 ? "vertical" : "horizontal"}
              source={"selectFluency"}
              setFluency={onChangeFluency}
            />
          </div>
        </Box>
      </ModalSlider>
