...
export default function NavBar(props) {
  ...
  useEffect(() => {
    if (logoutUserSuccessData) navigate("/");
  ...
  return (
    <NavBarWrapper>
        ...
        <NavRightSection>
          {!pathname.includes("/select") && (
            <NavChild1>
              <Language>
                <LanguageFlagWrapper>
                  {getLSItem("lang_id_agent") === "1" ? (
                    <img src="/Brand/english.png" alt="imag" />
                  ) : getLSItem("lang_id_agent") === "2" ? (
      ...
      <ModalWrapper>
        ...
        <OutsideClickCloseContainer setState={setShowBell}>
          {props.showBell && (
            <BellDropDown
