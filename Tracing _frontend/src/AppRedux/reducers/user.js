...
export const user = (state = initialState, action) => {
  ...
  switch (action.type) {
    ...
    case SET_SELECTLANGUAGE_BEGIN:
      return {
        ...state,
        setSelectLanguageBegin: true,
        setSelectLanguageSuccessData: null,
        setSelectLanguageFailureData: null,
      };

    case SET_SELECTLANGUAGE_SUCCESS:
      return {
        ...state,
        setSelectLanguageBegin: false,
        setSelectLanguageSuccessData: data,
        setSelectLanguageFailureData: null,
      };

    case SET_SELECTLANGUAGE_FAILURE:
      return {
        ...state,
        setSelectLanguageBegin: false,
        setSelectLanguageSuccessData: null,
        setSelectLanguagesFailureData: data,
      };

    case RESET_SET_SELECTLANGUAGE:
      return {
        ...state,
        setSelectLanguageBegin: false,
        setSelectLanguageSuccessData: null,
    ...
    case GET_SELECTLANGUAGE_BEGIN:
      return {
        ...state,
        getSelectLanguageBegin: true,
        getSelectLanguageSuccessData: null,
        getSelectLanguageFailureData: null,
      };

    case GET_SELECTLANGUAGE_SUCCESS:
      return {
        ...state,
        getSelectLanguageBegin: false,
        getSelectLanguageSuccessData: data,
        getSelectLanguageFailureData: null,
      };

    case GET_SELECTLANGUAGE_FAILURE:
      return {
        ...state,
        getSelectLanguageBegin: false,
        getSelectLanguageSuccessData: null,
        getSelectLanguagesFailureData: data,
      };

    case RESET_GET_SELECTLANGUAGE:
      return {
        ...state,
        getSelectLanguageBegin: false,
        getSelectLanguageSuccessData: null,
    ...
    case SET_SELECTMODEL_BEGIN:
      return {
        ...state,
        setSelectModelBegin: true,
        setSelectModelSuccessData: null,
        setSelectModelFailureData: null,
      };

    case SET_SELECTMODEL_SUCCESS:
      return {
        ...state,
        setSelectModelBegin: false,
        setSelectModelSuccessData: data,
        setSelectModelFailureData: null,
      };

    case SET_SELECTMODEL_FAILURE:
      return {
        ...state,
        setSelectModelBegin: false,
        setSelectModelSuccessData: null,
        setSelectModelFailureData: data,
      };

    case RESET_SET_SELECTMODEL:
      return {
        ...state,
        setSelectModelBegin: false,
        setSelectModelSuccessData: null,
    ...
    case GET_SELECTMODEL_BEGIN:
      return {
        ...state,
        getSelectModelBegin: true,
        getSelectModelSuccessData: null,
        getSelectModelFailureData: null,
      };

    case GET_SELECTMODEL_SUCCESS:
      return {
        ...state,
        getSelectModelBegin: false,
        getSelectModelSuccessData: data,
        getSelectModelFailureData: null,
      };

    case GET_SELECTMODEL_FAILURE:
      return {
        ...state,
        getSelectModelBegin: false,
        getSelectModelSuccessData: null,
        getSelectModelFailureData: data,
      };

    case RESET_GET_SELECTMODEL:
      return {
        ...state,
        getSelectModelBegin: false,
        getSelectModelSuccessData: null,
